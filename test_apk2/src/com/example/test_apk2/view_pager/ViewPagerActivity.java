package com.example.test_apk2.view_pager;
...
/**
 * 
 * ViewPagerSampe2.0.zip에서 가져 온 activity
 *
 */
		...
		for(int i=0; i<COUNT; i++)
		{
			...
			iv.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					int position = mPageMark.indexOfChild(v);
					mPager.setCurrentItem(position, isAnimated);
				}
			});
		}
